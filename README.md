...
#### **1.Download proxy**  
Download address: https://github.com/sunny5156/goproxyx/releases  
```shell  
cd /root/proxy/  
wget https://github.com/sunny5156/goproxyx/releases/download/v6.0/proxy-linux-amd64.tar.gz  
...
then cd to enter `github.com/sunny5156/goproxyx`.    
